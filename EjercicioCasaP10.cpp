...
glRotatef(vuelta, 0, 1, 0);
		//Pongo aquí la carroceria del carro
		glPushMatrix();
		
		glScalef(2.0, 2.0, 2.0);
		glTranslatef(0.0, 4.5, -6.0);
		glRotatef(RotY, 0, 1, 0);
		kit.GLrender(NULL, _SHADED, 1.0);  //_WIRED O _POINTS
		glPopMatrix();
	

		//Colocando las llantas en su lugar
		//Llanta 1
		glPushMatrix();
		glTranslatef(5.0, -1.0, 8.0);
		glRotatef(llantas, 1, 0, 0); //movKit Variable que crea la rotacion de la llanta
		glRotatef(180, 0, 1, 0);
		...
		//Llanta 2
		glPushMatrix();
		glTranslatef(-6.0, -1.0, 8.0);
		glRotatef(llantas, 1, 0, 0);
		llanta.GLrender(NULL, _SHADED, 1.0);
		glPopMatrix();

		//Llanta 3
		glPushMatrix();
		glTranslatef(-6.0, -1.0, 14.0);
		glRotatef(llantas, 1, 0, 0);
		glPushMatrix();
		...
		//Llanta 7
		glPushMatrix();
		glTranslatef(5.0, -1.0, 14.0);
		glRotatef(llantas, 1, 0, 0);
		glRotatef(180, 0, 0, 1);
		glPushMatrix();
		glRotatef(Direccion, 1, 0, 0);
		glPopMatrix();
		llanta.GLrender(NULL, _SHADED, 1.0);
		glPopMatrix();
	...
	glDisable(GL_LIGHTING);
		...
		pintaTexto(-12,12.0,-14.0,(void *)font,"Practica 10: Lopez Perez Marcos Emiliano");
...
// IF para delimitar la ida y vuelta
		if (movKit <= 270 )
		{
			movKit += 0.5;
			llantas += 10;
...
int main ( int argc, char** argv )   // Main Function
{
  ...
  glutCreateWindow    ("Practica 10 Ejercicio Casa"); // Nombre de la Ventana
