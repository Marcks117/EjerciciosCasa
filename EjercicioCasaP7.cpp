...
GLfloat SatDiffuse[] = { 0.35f, 0.25f, 0.2f, 1.0f };			// Saturno
GLfloat SatSpecular[] = { 1.0, 0.5, 0.0, 1.0 };
GLfloat SatShininess[] = { 50.0 };

GLfloat RingDiffuse[] = { 0.30f, 0.4f, 0.5f, 1.0f };			// Anillos
GLfloat RingSpecular[] = { 1.0, 0.5, 0.0, 1.0 };
GLfloat RingShininess[] = { 50.0 };

GLfloat UraDiffuse[] = { 0.0f, 0.2f, 0.7f, 1.0f };			// Urano
GLfloat UraSpecular[] = { 1.0, 0.5, 0.0, 1.0 };
GLfloat UraShininess[] = { 50.0 };

GLfloat NepDiffuse[] = { 0.0f, 0.0f, 0.3f, 1.0f };			// Neptuno
...
int main(int argc, char** argv)   // Main Function
{
	...
	glutCreateWindow("Práctica 7 Ejercicio Casa"); // Nombre de la Ventana
