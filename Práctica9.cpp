...
//************************************************************//
//************************************************************//
//**** Alumno (s): López Pérez Marcos Emiliano ***************//
//**** Práctica 9			        					******//
...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	t_metal01.LoadBMP("Madera1.bmp");
	t_metal01.BuildGLTexture();
	t_metal01.ReleaseImage();

	t_Ajedrez2.LoadTGA("04.tga");
...
//Tablero
void tablero(GLuint textura1, GLuint textura2)  //Funcion creacion prisma
{
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glTranslatef(pos_camX, pos_camY, pos_camZ);
		...
		glPushMatrix(); 
			...
			tablero(t_Ajedrez2.GLindex, t_metal01.GLindex);
		...
		glPushMatrix();
		glColor3f(1.0, 1.0, 1.0);
		glScalef(0.40, 4.5, 0.4);
		glTranslatef(3.0,-0.530,-3.0);
		prisma(t_metal01.GLindex, t_metal01.GLindex);
		glPopMatrix();
	...
	glDisable(GL_TEXTURE_2D);
		...
		renderBitmapCharacter(-11, 10.5, -14, (void *)font, "Textura transparente");
	glEnable(GL_TEXTURE_2D);
